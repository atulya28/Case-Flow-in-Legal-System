...
const Footer = () => {
    return (
        <div className='w-100 d-flex flex-column pt-0.5 bottom' style={{ borderTop: '1px solid black' }}>
            ...
            <div className='d-flex justify-content-center align-items-center w-100' style={{ background: "black", color: 'white', height: "5rem" }}>
                <div className='p-2' style={{ background: 'white', borderRadius: '1rem', height: '3.5rem' }}>
