...
const Header = () => {
  return (
    <div className='w-100 d-flex align-items-center justify-content-between p-3 py-1 ' style={{borderBottom: '1px solid black'}}>
      ...
      <div className='header-font2' style={{fontSize: '28px'}}>Prathamikata</div>
        <div className="d-flex align-items-center">
